...
__declspec(dllexport) BOOL CodeTokenizer::GetNextToken(String &token, BOOL bPeek)
{
    TSTR lpStart = lpTemp;
...
__declspec(dllexport)  BOOL CodeTokenizer::GetNextTokenEval(String &token, BOOL *bFloatOccurance, int curPrecedence)
{
...
__declspec(dllexport) BOOL CodeTokenizer::GotoToken(CTSTR lpTarget, BOOL bPassToken)
{
    String curToken;
