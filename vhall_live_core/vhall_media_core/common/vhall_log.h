...
void VHALL_LOG_ENABLE(bool enalbe);
...
#define LOGI(msg, ...)   if(vhall_log_enalbe) { vhall_log->Info(GetFormatDate() + ":" + INFO_HEADER + LOGTAG+ ":" + __func__ + ":" + int2str(__LINE__), msg, ##__VA_ARGS__);}
#define LOGD(msg, ...)   if(vhall_log_enalbe) { vhall_log->Debug(GetFormatDate() + ":" + DEBUG_HEADER + LOGTAG+ ":" + __func__ + ":" + int2str(__LINE__), msg, ##__VA_ARGS__);}
#define LOGW(msg, ...)   if(vhall_log_enalbe) { vhall_log->Warn(GetFormatDate() + ":" + WARN_HEADER + LOGTAG+ ":" + __func__ + ":" + int2str(__LINE__), msg, ##__VA_ARGS__);}
#define LOGE(msg, ...)   if(vhall_log_enalbe) { vhall_log->Error(GetFormatDate() + ":" + ERROR_HEADER + LOGTAG + ":" + __func__ + ":" + int2str(__LINE__), msg, ##__VA_ARGS__);}
