...
int VhallAudioMixingCore(short *inputData, short *outputData, int channelNum, int dataLength, int isSingleOut){
	int sum;
	int i,j;
...
int VhallAudioMixing(void *inputData, void *outputData, int channelNum, int sampleRate, int accuracyType, int isSingleOut){
	...
	ret = VhallAudioMixingCore(inputDataSafe, outputDataSafe, channelNum, dataLength, isSingleOut);
