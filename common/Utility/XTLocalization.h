...
#define Str(text) XTGetLocale()->LookupString(TEXT2(text))

inline BOOL  LoadStringFile(CTSTR lpResource)   {return XTGetLocale()->LoadStringFile(lpResource);}
...
BASE_EXPORT bool LocaleIsRTL(LocaleStringLookup *l = XTGetLocale());
#endif
