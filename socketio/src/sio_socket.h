...
namespace sio
{
    ...
    public:
        ...
        void emit(std::string const& name, message::list const& msglist = nullptr, std::function<void (message::list const&)> const& ack = nullptr, uint64_t timeOut = 0);
       // add by liwenlong on 2018.1.19
       void emit(std::string const& name, message::list const& msglist = nullptr, message::ptr const& option = nullptr, std::function<void (message::list const&)> const& ack = nullptr, uint64_t timeOut = 0);
